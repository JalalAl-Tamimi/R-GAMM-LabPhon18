...
The four additional plots show the autocorrelation in teh residuals for time, context, vowel and word. All of these predictors are showing autocorrelations between their successive points. It is crucial to tell the model to account for this, otherwise there is overconfidence in the estimates. 
...
3. An intercept only model (=Null) without any terms associated with the predictory "vowel" (phar.gam.AR.ML.Min.ContextAndVowel)
